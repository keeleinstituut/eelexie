...
function ShowDicHelp() {
    if ((appDesc == "EXSA")) {
        ...
        window.open("http://eelextest.eki.ee/~eelex/juhendid/eelex_juhend/EELex_juhend.htm", "_blank", "channelmode=no,directories=no,fullscreen=no,location=yes,menubar=no,resizable=yes,scrollbars=yes,status=yes,titlebar=yes,toolbar=yes");
    }
...
function ClickArtToolsMenu() {
	...
	// ats+++  (22.01.2013/22.01.2013)
   	// ======================================================================================================
          ...
          else if (window.event.srcElement.parentElement.value == "idViitKontr") {
            atsViitOnOff();
        }
    //ats
