...
function srvXmlValidate() {
    ...
    var seldId, seldTekst, pathName = window.location.pathname; // ilma sabadeta (?, #), algab '/'; nt "/__shs_test/art_le.cgi"
    var scriptName = pathName.substr(pathName.lastIndexOf('/') + 1);


    if (scriptName == "art_le.cgi") { // IE versioon
        var volSelElement = document.getElementById("sel_Vol"); // art_le.cgi, IE versioon
...
// praegu - 21juun12 - ainult art_le.cgi (IE)
// 
//-----------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------
/** 
* Lisab valmispäringud funktsiooniga LisaKoondParing. Valmispäringud on siin funktsioonis. Ainult art_le.cgi (IE).
*
...
/** 
* Müstiline funktsioon, mida kasutatakse funktsioonis valmisParingud. Ainult art_le.cgi (IE).
*
