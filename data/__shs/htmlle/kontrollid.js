...
/**
* kontrollid.js
* Funktsioonid, mis toimetamise ajal kontrollivad ja muudavad tähendusnumbreid jms.
*
* @class kontrollid
*/
...
/**
* (TODO Kus see välja kutsutakse?) Teisendab teksti
*
* @method tekstiTeisendused
* @param {String} tekst
* @returns {String} 
*/
...
/**
* (TODO Kus see välja kutsutakse?) Kontrollib.
*
* @method ValueChecks
* @param {String} newTxtVal 
* @param {String} oldTxtVal 
*/
...
/**
* (TODO Kus, miks kellele välja kutsutakse? ) Määrab aT ja aTA.
*
* @method setATTAPlokid
* @param {Object} kontrollitav 
*/
function setATTAPlokid(kontrollitav) {
    if (aTTAPlokid.length > 1) {
...
/**
* TODO Arvatavasti kontroll, mis tehakse elemendi väljalt lahkudes.
*
* @method ValueDicChecks
* @param {String} uusTekst Muudetava elemendi väärtus.
*/
...
/**
* Kontrollib artiklit. Kutsutakse välja enne salvestamist.
*
* @method ArtSaveChecks
*/
...
/**
* Kasutatakse sõnaperedega. Tegeleb elementidega ml, mm.
*
* @method SetMallid
*/
function SetMallid() {
...
/**
* (TODO kus välja kutsutakse?) Tagastab märksõnast üleliigsed märgid.
*
* @method SetMallid
* @param {Object} oNode
* @returns {String} 
...
/**
* (TODO kus välja kutsutakse?) Ei tee midagi.
*
* @method TeisendaDOM
* @param {Object} thisdomdoc Muudetav DOM.
*/
...
/**
* Käivitatakse grupi loomisel. Tegeleb tähendusnumbritega.
*
* @method AddGruppChecks
* @param {Object} oAddedNode
*/
...
/**
* Arvutab funktsioonile AddGruppChecks tähendusnumbrid.
*
* @method arvutaTxhendusNumbrid
* @param {Object} parNode
* @param {String} seldNodeName
*/
