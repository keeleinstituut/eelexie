/**
* procs_TextContMenu.js
* Kontekstmenüüdega opereerimine.
*
* @class procs_TextContMenu
*/
...
* 
* @property openmenuid
* @type {String} HTML elemendi id.
*/
var openmenuid;
/**
* See muutuja on mujal, aga hoitakse menüü elementi.
* 
* @property tn_cmenu
...
/**
*     Käsitleb nii cmenu (tavaline kontekstmenüü) kui ka tn_cmenu (mixed=true #text sees tekkiv kontekstmenüü) onmouseover-it ja onmouseout-i. Ühel ajal korraga nad lahti ei ole, capture on korraga ühel neist
*
* @method SwitchCMenu
*/
...
/**
* Näitab kontekstmenüüd määratud kohas.    
*
* @method DisplayTNCMenu
* @param {Int} posx
* @param {Int} posy
*/
...
/**
* Kui seda funktsiooni on kutsutud, siis kontekstmenüüd enam ei tule.    
*
...
/**
* Näitab tähte suuremalt kui menüüs näha.
*
* @method ShowBigCharacter
* @param {String} cHTML Mida näidatakse.
* @param {Int} x Pikslites.
* @param {Int} y Pikslites.
* @param {String} fs Font Style.
...
/**
* Peidab suure tähepildi ära.
*
* @method HideBigCharacter
*/
...
/**
* Pannakse kokku sümbolite menüü.
*
* @method FillInsertSymbolsMenu
*/
