...
{
  var i, zNzimi, zAttrHom, zArtElemCnt, zVol, zG, zzField;
  ...
  for (i = 0; i < zArtElemCnt; i ++)
  {
    ...
    zNzimi = zzArtElements(i).selectSingleNode("l/t/" + zzMarkS).text;
    zAttrHom = zzArtElements(i).selectSingleNode("l/t/" + zzMarkS).getAttribute(zzDicpr + ":i");
    if (zAttrHom == null)
    {
      zAttrHom = "";
    }
