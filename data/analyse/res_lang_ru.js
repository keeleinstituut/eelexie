...
//GetQueryParams
var CASE_INSENSITIVE = "без учёта рег.";
var CASE_SENSITIVE = "с учётом регистра";
var SYMS_EXCLUDED = "только буквы";
var SYMS_INCLUDED = "все знаки";
var GLOBAL_WORD = "глоб.";
var LOCAL_WORD = "лок.";
var CONT_QUERY_Q = "Текст содержит *не-букв*. Пожалуйста, проверьте флажок символов!"
...
//InitSpellVars
var ET_SPELLER_MISSING = "Estonian speller is missing!";
var RU_SPELLER_MISSING = "Russian speller is missing!"
...
//HandleContextClick
var MNU_ADD = "Добвляй злемент";
var MNU_ADD_BEFORE = "Добвляй злемент вперёд";
var MNU_ADD_CHILD = "Добвляй злемент во внутрь";
var MNU_ADD_AFTER = "Добвляй злемент вслед";
var MNU_ADD_ATTRS = "Добвляй атрибут";
var MNU_RENAME = "Переименовать";
var MNU_INCR_INDENT = "Увеличивать отступ";
var MNU_DECR_INDENT = "Уменьшать отступ";
var MNU_CUT = "Отрезать";
var MNU_CUT_ADD = "Отрезать и добавлять";
var MNU_COPY = "Копировать";
var MNU_COPY_ADD = "Копировать и добавлять";
var MNU_PASTE = "Склеивать";
var MNU_PASTE_BEFORE = "Вперёд";
var MNU_PASTE_CHILD = "Добавлять как внуренний элемент";
var MNU_PASTE_AFTER = "Вслед";
var MNU_PASTE_REPLACE = "Заменить";
var MNU_DELETE = "Удалить";
var MNU_OPEN_FORCOPY = "Открыть для копирования";
var MNU_ADD_XMLCOMMENT = "Добавлять XML комментарий";
var MNU_OPEN_FIND_REPLACE = "Открыть для изменения во всех томах";
//
...
var MNU_INS_SYM_UDMURTIAN = "Udmurtian symbols";
